...
Success!! Calling this method returns our expected result when the game pad buttons are pressed.
...
### Success we can now invoke our method
```c++
void BeginRender()
{
