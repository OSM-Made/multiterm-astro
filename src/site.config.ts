...
const config: SiteConfig = {
  ...
  site: 'https://www.hackingadventures.ca/',
  ...
  giscus: {
    repo: 'OSM-Made/multiterm-astro',
    repoId: 'R_kgDOQeX74A',
    category: 'General',
    categoryId: 'DIC_kwDOQeX74M4CzJIM',
